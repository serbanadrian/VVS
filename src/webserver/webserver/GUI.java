...
public class GUI {
    ...
    private void createGUI() {
        ...
        topSection.setBackground(new Color(144, 238, 144));
    ...
    private JPanel createControlArea() {
        ...
        maintenanceModeCheck.setBackground(new Color(144, 238, 144));
    ...
    private JPanel createInfoArea() {
        ...
        JLabel label = new JLabel("Status server: ");
        ...
        label = new JLabel("Adresa server: ");
    ...
    private JPanel createConfigArea() {
        ...
        JPanel panel2 = new JPanel(new FlowLayout());
        panel2.setBackground(new Color(144, 238, 144));
        label = new JLabel("Director pentru root: ");
        rootDirectoryAddress = new JTextField(13);
        if (settings != null) {
        ...
        JPanel panel3 = new JPanel(new FlowLayout());
        panel3.setBackground(new Color(144, 238, 144));
        label = new JLabel("Director pentru mentenanta: ");
        maintenanceDirectoryAddress = new JTextField(9);
        if (settings != null) {
